...
calculation = submit(builder)
        ...
        # self.ctx.energy_threshold_vacuum = workchain_vacuum.outputs.output_parameters.get_dict()['energy_threshold']
        # self.ctx.energy_threshold_solution = workchain_solution.outputs.output_parameters.get_dict()['energy_threshold']
